            ...
            <div className="bg- pt-40 py-20 marginFeature bg-featured">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center pt-48 pb-10 md:pt-96">
                        <h3 className="text-4xl sm:text-6xl font-bold text-theme2 my-2">Our Featured Works.</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold text-theme2 text-opacity-50 lg:mr-48 my-2">Our Featured Works.</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold text-theme2 text-opacity-25 lg:-mr-32 my-2">Our Featured Works.</h3>
                    </div>
                    <h3 className="text-center text-4xl sm:text-6xl font-bold text-theme2 pt-16 my-2">Logo Samples</h3>
                    <Slider {...settings}>
                        {postData.map((items, i) => (
                            <div key={i}>

                                <div className=' justify-center bg-transparent m-3 pb-12 my-10 rounded-3xl'>
                                    ...
                                    <div className="w-345">
                                        <h4 className='sm:text-3xl font-medium sm:pt-6 text-center sm:text-start mt-5 text-theme2'>{items.heading}</h4>
                                    </div>
                                </div>
