...
const Digital = () => {
    return (
        ...
        <div className="mx-2">
            <div className='mx-auto max-w-7xl px-4 my-40 pb-20 lg:pb-40 lg:px-8 bg-digital rounded-3xl bg-theme2 relative'>
                <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                    ...
                    <div className="pt-24 lg:pl-24 ">
                        ...
                        <div className="text-center lg:text-start">
                            <Link href='/about-us'>
                                <button className="text-xl font-semibold text-white bg-theme3 py-4 px-12 hover:bg-theme1 rounded-full">Get started</button>
                            </Link>
                        </div>
                    </div>
