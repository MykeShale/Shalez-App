            ...
            <>
                <div className=" inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto md:ml-6 sm:pr-0">
                    ...
                    <div className='hidden lg:block'>
                        <button type="button" className='justify-end text-xl font-semibold bg-transparent py-4 px-6 lg:px-12 navbutton rounded-full hover:bg-theme1 hover:text-white hover:border-transparent' onClick={openModal}>
                            Reach Us
                        </button>
                    </div>
                </div>
                                    ...
                                    <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                        ...
                                        <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                                            <div className="flex flex-shrink-0 items-center justify-center">
                                                <Link href="/" className='text-2xl sm:text-4xl font-semibold text-theme1'>
                                                    The Shalez
                                                </Link>
                                            </div>
                                            <p className="mb-8 lg:mb-10 mt-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Reach us now for Enquiries or feedback😊</p>
                                            <form action="#" className="space-y-8" onSubmit={handleSubmit}>
                                                ...
                                                <button type="submit"
                                                    onClick={handleClick}
                                                    disabled={isDisabled}
                                                    className="py-3 px-5 text-sm disabled:opacity-50 font-medium w-full text-center text-white rounded-lg bg-theme1 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>

                                                <h1 className='text-center text-lg font-medium'>Or Give us a Call: 0792 099 302</h1>
